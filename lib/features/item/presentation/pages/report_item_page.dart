...
void _showPermissionDeniedDialog(){
  showDialog(context: context, builder: (context) => AlertDialog(
    ...
    content: Text("Yo feature haru use garna lai permission settings ma janu hola haii"),
    actions: [
...
Future<void> _pickFromVideo() async {
  try{
    ...
    final XFile? video = await _imagePicker.pickVideo(source: ImageSource.camera, maxDuration: const Duration(minutes: 1),);
  ...
  builder: (context) => SafeArea(child: Padding(
    ...
    child: Column(
      ...
      children: [
        ...
        ListTile(leading: Icon(Icons.video_file),
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(image: FileImage(File(_selectedMedia[0].path)))
                              ),
                            ),
                            Positioned(
                              top: 4,
