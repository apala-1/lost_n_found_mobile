...
debugPrint('📊 BatchStatus: ${batchState.status}');
debugPrint('📦 UI batch count: ${batchState.batches.length}');
    ...
    final validSelectedBatch = batchState.batches
        .any((b) => b.batchId == _selectedBatch)
    ? _selectedBatch
    : null;
