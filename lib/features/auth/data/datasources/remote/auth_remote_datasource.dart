...
final authRemoteDatasourceProvider = Provider<IAuthRemoteDataSource>((ref) {
  return AuthRemoteDatasource(
    ...
    userSessionService: ref.read(userSessionServiceProvider), tokenService: ref.read(tokenServiceProvider),
  );
});
...
class AuthRemoteDatasource implements IAuthRemoteDataSource {
  ...
  AuthRemoteDatasource({
    ...
    required UserSessionService userSessionService, required TokenService tokenService,
